...
const Dashboard = () => {
  ...
  const fetchStats = async () => {
    try {
      const response = await axios.get(`${baseURL}/api/relatorios`);
            ...
            <div className="px-4 py-5 sm:p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <button className="bg-purple-600 hover:bg-purple-700 text-white px-4 py-3 rounded-md text-sm font-medium flex items-center justify-center">
                  <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M9 2a1 1 0 000 2h2a1 1 0 100-2H9z" />
                    <path fillRule="evenodd" d="M4 5a2 2 0 012-2v1a1 1 0 102 0V3h4v1a1 1 0 102 0V3a2 2 0 012 2v6a2 2 0 01-2 2H6a2 2 0 01-2-2V5zm8 8a1 1 0 01-1 1H9a1 1 0 01-1-1V9a1 1 0 011-1h2a1 1 0 011 1v4z" clipRule="evenodd" />
                  </svg>
                  Gerar Relatório
                </button>
              </div>
            ...
            <div className="px-4 py-5 sm:p-6">
              ...
              <dl className="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2">
                ...
                <div>
                  ...
                  <dd className="mt-1 text-sm text-gray-900">
                    {stats && new Date(stats.gerado_em).toLocaleString('pt-BR')}
                  </dd>
                </div>
              </dl>
            </div>
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                ...
                <div className="mt-2 text-sm text-green-700">
                  <p>
                    🎉 <strong>API Completa de Gestão de Equipamentos Médicos funcionando perfeitamente!</strong>
                  </p>
                  <ul className="list-disc list-inside mt-2">
                    <li>✅ Autenticação JWT implementada</li>
                    <li>✅ Dashboard com estatísticas em tempo real</li>
                    <li>✅ Sistema de equipamentos e manutenções</li>
